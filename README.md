...
*This document (the README file) is a hub to give you some information about the project. Jump straight to one of the sections below, [skip right to contributing](https://github.com/chrisbresky/Aquarius-Project/edit/master/CONTRIBUTING.md) or just scroll down to find out more. And please review our [Code of Conduct](https://github.com/chrisbresky/Aquarius-Project/blob/master/CODE%20OF%20CONDUCT.md) to help this community play a part in making open science engagement welcoming for all. *
